...
string runMCMC2(vector<Tree> &bestTrees, int noOfReps, int noOfLoops, double gamma, vector<double> moveProbs, int n, int m, double** logAltLL, double** logRefLL, char scoreType, int* trueParentVec, int step, bool sample, bool useTreeList, char treeType);

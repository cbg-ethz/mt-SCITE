...
std::string getGraphVizFileContentNames2(int* parents, int n, std::vector<std::string> geneNames, bool attachSamples, bool** ancMatrix, int m, double** logAltLL, double** logRefLL);
...
std::string getBestAttachmentString2(bool ** ancMatrix, int n, int m, double** logAltLL, double** logRefLL, std::vector<std::string> geneNames);
